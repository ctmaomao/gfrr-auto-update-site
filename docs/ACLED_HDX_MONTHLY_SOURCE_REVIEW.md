...
- 独立的手工更新任务已于 2026-09-09 发布 `02e8970b`，World Order 产物为 `2bf27d42`：周度 Africa / Middle-East / Latin-America 截止 2026-08-28，其余三区仍为 2026-08-14；月度六文件截至 2026-08-21。此前“未找到新月表”是 9 月 8 日检索结果，不再代表当前输入。此手工发布不是 HDX/HAPI 自动接入或同源版本等价验证。
