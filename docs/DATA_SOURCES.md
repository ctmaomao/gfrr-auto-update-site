...
后续免手工目标使用[逐指标替代验收](ACLED_HDX_MONTHLY_SOURCE_REVIEW.md#替代验收与免手工目标2026-09-16)：新增零网络报告及规范化PV逐行比较核心；当前真实引用缺失，原24月不覆盖年度四年基线。独立批准的[一次年度验收](ACLED_HDX_MONTHLY_SOURCE_REVIEW.md#年度候选与公开筛选规则2026-09-16)已用4请求/3,723,475字节取得218返回国家代码的2022–2025完整48月私有候选，零网络复验通过；不扩四槽预算、不自动重跑、旧替代报告尚未接入年度档案。官网已说明两死亡产品定义，但与HAPI实际映射、全球覆盖、同版本逐行数值及免费周表自动渠道仍未证明。已将既有ARR本地heartbeat合并为双任务跟进，不改GitHub提醒/生产来源；本次未发邮件。
