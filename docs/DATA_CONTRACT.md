...
Route-level tanker freight proof-of-source 当前只是设计契约:manual artifact scaffold 也必须 dry-run-only、ignored artifact-only,不得自动抓取 Baltic/ICE/CME/vendor 页面或写 production data。
