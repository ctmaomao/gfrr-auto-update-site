...
- Energy Stress Phase 2 的 `energyTransport` 只能标注为 PortWatch AIS-derived chokepoint proxy；公开 repo 只保存 compact 派生摘要，不提交 raw AIS-derived 120 天历史；不得写成官方贸易统计、实际油轮流量确认、封锁确认、战争概率、断供概率或油价预测。
