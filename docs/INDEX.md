...
- [ADR-0035](ADR/0035-check-suite-deduplication.md)：检查执行去重与传递覆盖校验；保留全部 leaf 断言和独立 checker/合并审阅。

- [ADR-0034](ADR/0034-final-editorial-write-revalidation.md)：最终编辑层写入复验与有界诊断；不放宽来源、付费、评分或部署权限。
