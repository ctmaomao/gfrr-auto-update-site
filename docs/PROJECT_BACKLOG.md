...
| Cache version | `stage-70city-detail-1` |
...
- **当前进行中**: 70 城城市明细折叠已上线(commit `e03c36a`,`tierBreakdown` + C6 `<details>`,check:all 全绿)+ backlog 收尾(本次)。Stage 10 数据已 live 验证;UX 清理 `5153815`、hotfix `32237c9` 均合并。**70 城明细 stage 待线上 Daily run 验证**(tierBreakdown 出现,每 tier 城数 4/31/35,一线新房上涨=上海/广州/深圳)。
