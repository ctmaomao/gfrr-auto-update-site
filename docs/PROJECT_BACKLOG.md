...
| Cache version | `stage-ux-meta-cleanup-1` |
...
- **当前进行中**: Stage 10 **线上验证通过**(Daily `ee390fa`:chinaPropertyPrice=live,新建 14/7/49、二手 12/4/54,各和=70);deploy hotfix(`32237c9`)+ UX 文案清理(`5153815`)均已合并。**下一个 stage = 70 城城市明细折叠(方案 A,owner 拍板)**:每线(一线4/二线31/三线35)× 新房/二手,列上涨城市名 + 涨/平/跌计数,原生 `<details>` 折叠。outline 进行中。
