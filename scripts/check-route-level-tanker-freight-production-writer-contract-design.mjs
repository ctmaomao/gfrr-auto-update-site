...
function assertAuthorityDocs() {
  ...
  assertIncludes(backlog, 'Route-level tanker freight production writer contract design', 'docs/PROJECT_BACKLOG.md');
  assertIncludes(agents, 'route-level tanker freight production writer contract design', 'AGENTS.md');
