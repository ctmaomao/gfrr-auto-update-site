...
function assertAuthorityDocs() {
  ...
  assertIncludes(backlog, 'Route-level tanker freight source-rights gate update proposal review', 'docs/PROJECT_BACKLOG.md');
  assertIncludes(agents, 'route-level tanker freight source-rights gate update proposal review', 'AGENTS.md');
