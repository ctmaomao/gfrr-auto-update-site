...
const APP_VERSION = 'observation-reaction-risk-band-1';
...
async function main() {
  ...
  try {
    const { renderMacroOverview } = await import('./modules/renderMacroOverview.js?v=observation-reaction-risk-band-1');
