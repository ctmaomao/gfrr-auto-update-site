...
const APP_VERSION = 'odp-energy-inventory-balance-1';
...
async function main() {
  ...
  try {
    const { renderMacroOverview } = await import('./modules/renderMacroOverview.js?v=odp-energy-inventory-balance-1');
