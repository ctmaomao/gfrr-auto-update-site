...
const APP_VERSION = 'transport-shock-score-attribution-1';
...
async function main() {
  ...
  try {
    const { renderMacroOverview } = await import('./modules/renderMacroOverview.js?v=transport-shock-score-attribution-1');
