...
const APP_VERSION = 'external-ai-warning-readability-1';
...
async function main() {
  ...
  try {
    const { renderMacroOverview } = await import('./modules/renderMacroOverview.js?v=external-ai-warning-readability-1');
