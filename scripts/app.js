...
const APP_VERSION = 'odp-thermal-facility-window-quality-1';
...
async function main() {
  ...
  try {
    const { renderMacroOverview } = await import('./modules/renderMacroOverview.js?v=odp-thermal-facility-window-quality-1');
