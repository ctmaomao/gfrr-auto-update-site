...
const APP_VERSION = 'stage-c5-batch1-world-indices-1';
...
async function main() {
  ...
  try {
    const { renderMacroOverview } = await import('./modules/renderMacroOverview.js?v=stage-c5-batch1-world-indices-1');
