...
function assertAuthorityDocs() {
  ...
  assert(backlog.includes('Route-level tanker freight manual artifact scaffold'), 'PROJECT_BACKLOG missing manual artifact scaffold marker.');
  assert(agents.includes('route-level tanker freight manual artifact scaffold'), 'AGENTS.md missing manual artifact scaffold boundary.');
