...
function assertAuthorityDocs() {
  ...
  assertIncludes(backlog, 'Route-level tanker freight source-rights approval gate', 'docs/PROJECT_BACKLOG.md');
  assertIncludes(agents, 'route-level tanker freight source-rights approval gate', 'AGENTS.md');
