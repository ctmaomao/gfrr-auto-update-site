...
for (const [fileKey, marker] of [
  ...
  ['projectBacklog', 'Transport Shock Confirmation Factor frontend score-impact row'],
  ['projectBacklog', 'Transport Shock Confirmation Factor frontend score attribution'],
