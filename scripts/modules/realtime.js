import { dataUrl, historyUrl, localRealtimeUrl, worldOrderStressUrl, REMOTE_REALTIME_URL, realtimeSourcePolicy, fmtNumSafe } from './config.js?v=a-scope-jargon-sweep-1';
import {
  computeAgeMinutes,
...
} from './freshness.js?v=a-scope-jargon-sweep-1';
import { buildHealthDashboardModel } from './health.js?v=a-scope-jargon-sweep-1';
import { buildDecisionModel } from './decision.js?v=a-scope-jargon-sweep-1';
import {
...
} from './displayTextBuilders.js?v=a-scope-jargon-sweep-1';
