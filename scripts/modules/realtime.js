import { dataUrl, historyUrl, localRealtimeUrl, worldOrderStressUrl, REMOTE_REALTIME_URL, realtimeSourcePolicy, fmtNumSafe } from './config.js?v=energy-physical-chain-1';
import {
  computeAgeMinutes,
...
} from './freshness.js?v=energy-physical-chain-1';
import { buildHealthDashboardModel } from './health.js?v=energy-physical-chain-1';
import { buildDecisionModel } from './decision.js?v=energy-physical-chain-1';
import {
...
} from './displayTextBuilders.js?v=energy-physical-chain-1';
