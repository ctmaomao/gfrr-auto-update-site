import { dataUrl, historyUrl, localRealtimeUrl, worldOrderStressUrl, REMOTE_REALTIME_URL, realtimeSourcePolicy, fmtNumSafe } from './config.js?v=external-ai-pr4b2-1';
import {
  computeAgeMinutes,
...
} from './freshness.js?v=external-ai-pr4b2-1';
import { buildHealthDashboardModel } from './health.js?v=external-ai-pr4b2-1';
import { buildDecisionModel } from './decision.js?v=external-ai-pr4b2-1';
import {
...
} from './displayTextBuilders.js?v=external-ai-pr4b2-1';
