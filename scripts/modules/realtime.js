import { dataUrl, historyUrl, localRealtimeUrl, worldOrderStressUrl, REMOTE_REALTIME_URL, realtimeSourcePolicy, fmtNumSafe } from './config.js?v=threshold-scale-1to1-1';
import {
  computeAgeMinutes,
...
} from './freshness.js?v=threshold-scale-1to1-1';
import { buildHealthDashboardModel } from './health.js?v=threshold-scale-1to1-1';
import { buildDecisionModel } from './decision.js?v=threshold-scale-1to1-1';
import {
...
} from './displayTextBuilders.js?v=threshold-scale-1to1-1';
