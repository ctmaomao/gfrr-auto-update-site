import { dataUrl, historyUrl, localRealtimeUrl, worldOrderStressUrl, REMOTE_REALTIME_URL, realtimeSourcePolicy, fmtNumSafe } from './config.js?v=odp-oil-news-source-health-1';
import {
  computeAgeMinutes,
...
} from './freshness.js?v=odp-oil-news-source-health-1';
import { buildHealthDashboardModel } from './health.js?v=odp-oil-news-source-health-1';
import { buildDecisionModel } from './decision.js?v=odp-oil-news-source-health-1';
import {
...
} from './displayTextBuilders.js?v=odp-oil-news-source-health-1';
