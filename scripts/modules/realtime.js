import { dataUrl, historyUrl, localRealtimeUrl, worldOrderStressUrl, REMOTE_REALTIME_URL, realtimeSourcePolicy, fmtNumSafe } from './config.js?v=ai-bubble-tab-label-1';
import {
  computeAgeMinutes,
...
} from './freshness.js?v=ai-bubble-tab-label-1';
import { buildHealthDashboardModel } from './health.js?v=ai-bubble-tab-label-1';
import { buildDecisionModel } from './decision.js?v=ai-bubble-tab-label-1';
import {
...
} from './displayTextBuilders.js?v=ai-bubble-tab-label-1';
