import { fmtNumSafe, riskColor, trendClass } from './config.js?v=macro-risk-editorial-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=macro-risk-editorial-1';
