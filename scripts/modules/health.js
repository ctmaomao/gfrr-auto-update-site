import { fmtNumSafe, riskColor, trendClass } from './config.js?v=stage-9-c6-intro-errata-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=stage-9-c6-intro-errata-1';
