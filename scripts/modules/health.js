import { fmtNumSafe, riskColor, trendClass } from './config.js?v=frontend-stale-static-wire-2';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=frontend-stale-static-wire-2';
