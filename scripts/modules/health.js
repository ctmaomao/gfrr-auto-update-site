import { fmtNumSafe, riskColor, trendClass } from './config.js?v=observation-reaction-risk-band-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=observation-reaction-risk-band-1';
