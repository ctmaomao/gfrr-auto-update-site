import { fmtNumSafe, riskColor, trendClass } from './config.js?v=stage-wo-overlay-history-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=stage-wo-overlay-history-1';
