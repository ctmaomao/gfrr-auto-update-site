import { fmtNumSafe, riskColor, trendClass } from './config.js?v=odp-decision-ladder-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=odp-decision-ladder-1';
