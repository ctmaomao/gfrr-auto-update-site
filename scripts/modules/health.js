import { fmtNumSafe, riskColor, trendClass } from './config.js?v=odp-news-source-attribution-2';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=odp-news-source-attribution-2';
