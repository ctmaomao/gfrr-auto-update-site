import { fmtNumSafe, riskColor, trendClass } from './config.js?v=external-ai-pr4b2-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=external-ai-pr4b2-1';
