import { fmtNumSafe, riskColor, trendClass } from './config.js?v=mobile-narrow-blocks-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=mobile-narrow-blocks-1';
