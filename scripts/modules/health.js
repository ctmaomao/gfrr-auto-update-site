import { fmtNumSafe, riskColor, trendClass } from './config.js?v=frontend-loading-state-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=frontend-loading-state-1';
