import { fmtNumSafe, riskColor, trendClass } from './config.js?v=trend-axis-overlay-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=trend-axis-overlay-1';
