import { fmtNumSafe, riskColor, trendClass } from './config.js?v=ai-bubble-tab-label-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=ai-bubble-tab-label-1';
