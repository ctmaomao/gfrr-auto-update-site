import { fmtNumSafe, riskColor, trendClass } from './config.js?v=frontend-zh-copy-2';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=frontend-zh-copy-2';
