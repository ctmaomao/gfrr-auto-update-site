import { fmtNumSafe, riskColor, trendClass } from './config.js?v=stage-14-tsf-eastmoney-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=stage-14-tsf-eastmoney-1';
