import { fmtNumSafe, riskColor, trendClass } from './config.js?v=mobile-trend-width-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=mobile-trend-width-1';
