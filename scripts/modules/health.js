import { fmtNumSafe, riskColor, trendClass } from './config.js?v=odp-hero-ref-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=odp-hero-ref-1';
