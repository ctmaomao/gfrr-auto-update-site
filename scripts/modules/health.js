import { fmtNumSafe, riskColor, trendClass } from './config.js?v=bookmarks-right-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=bookmarks-right-1';
