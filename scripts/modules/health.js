import { fmtNumSafe, riskColor, trendClass } from './config.js?v=odp-ais-gap-check-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=odp-ais-gap-check-1';
