import { fmtNumSafe, riskColor, trendClass } from './config.js?v=odp-buffer-tone-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=odp-buffer-tone-1';
