import { fmtNumSafe, riskColor, trendClass } from './config.js?v=stage-15-omo-eastmoney-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=stage-15-omo-eastmoney-1';
