import { fmtNumSafe, riskColor, trendClass } from './config.js?v=stage-70city-detail-2';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=stage-70city-detail-2';
