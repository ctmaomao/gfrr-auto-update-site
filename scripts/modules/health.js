import { fmtNumSafe, riskColor, trendClass } from './config.js?v=stage-c5-world-economy-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=stage-c5-world-economy-1';
