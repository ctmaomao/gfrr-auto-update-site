import { fmtNumSafe, riskColor, trendClass } from './config.js?v=mobile-asset-table-scroll-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=mobile-asset-table-scroll-1';
