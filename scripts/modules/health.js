import { fmtNumSafe, riskColor, trendClass } from './config.js?v=odp-timing-tiers-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=odp-timing-tiers-1';
