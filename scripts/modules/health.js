import { fmtNumSafe, riskColor, trendClass } from './config.js?v=odp-wti-market-proxy-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=odp-wti-market-proxy-1';
