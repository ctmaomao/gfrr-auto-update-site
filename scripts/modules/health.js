import { fmtNumSafe, riskColor, trendClass } from './config.js?v=release-version-semantics-v28.0.10-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=release-version-semantics-v28.0.10-1';
