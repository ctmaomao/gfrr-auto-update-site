import { fmtNumSafe, riskColor, trendClass } from './config.js?v=transport-shock-score-gate-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=transport-shock-score-gate-1';
