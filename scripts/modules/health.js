import { fmtNumSafe, riskColor, trendClass } from './config.js?v=odp-web-ngrams-health-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=odp-web-ngrams-health-1';
