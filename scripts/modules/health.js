import { fmtNumSafe, riskColor, trendClass } from './config.js?v=transport-shock-caveat-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=transport-shock-caveat-1';
