import { fmtNumSafe, riskColor, trendClass } from './config.js?v=odp-data-cache-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=odp-data-cache-1';
