import { fmtNumSafe, riskColor, trendClass } from './config.js?v=mobile-fullwidth-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=mobile-fullwidth-1';
