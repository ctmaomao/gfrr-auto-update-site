import { fmtNumSafe, riskColor, trendClass } from './config.js?v=gold-observation-reaction-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=gold-observation-reaction-1';
