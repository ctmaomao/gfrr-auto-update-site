import { fmtNumSafe, riskColor, trendClass } from './config.js?v=zh-term-standard-4';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=zh-term-standard-4';
