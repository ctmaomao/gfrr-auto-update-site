import { fmtNumSafe, riskColor, trendClass } from './config.js?v=observation-reaction-layer-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=observation-reaction-layer-1';
