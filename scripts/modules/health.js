import { fmtNumSafe, riskColor, trendClass } from './config.js?v=brent-basis-check-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=brent-basis-check-1';
