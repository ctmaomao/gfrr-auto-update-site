import { fmtNumSafe, riskColor, trendClass } from './config.js?v=brent-held-age-cap-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=brent-held-age-cap-1';
