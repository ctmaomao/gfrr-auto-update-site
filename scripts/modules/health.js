import { fmtNumSafe, riskColor, trendClass } from './config.js?v=m94-css-cleanup-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=m94-css-cleanup-1';
