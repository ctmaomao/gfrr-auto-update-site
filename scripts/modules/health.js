import { fmtNumSafe, riskColor, trendClass } from './config.js?v=thematic-ia-regional-last-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=thematic-ia-regional-last-1';
