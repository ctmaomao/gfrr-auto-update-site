import { fmtNumSafe, riskColor, trendClass } from './config.js?v=frontend-stale-static-tier1-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=frontend-stale-static-tier1-1';
