import { fmtNumSafe, riskColor, trendClass } from './config.js?v=stage-trend-path-reorder-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=stage-trend-path-reorder-1';
