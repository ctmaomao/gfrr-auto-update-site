import { fmtNumSafe, riskColor, trendClass } from './config.js?v=trend-visual-match-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=trend-visual-match-1';
