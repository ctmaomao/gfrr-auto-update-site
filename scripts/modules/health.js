import { fmtNumSafe, riskColor, trendClass } from './config.js?v=odp-energy-theme-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=odp-energy-theme-1';
