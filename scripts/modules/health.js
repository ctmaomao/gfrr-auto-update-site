import { fmtNumSafe, riskColor, trendClass } from './config.js?v=odp-responsive-readability-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=odp-responsive-readability-1';
