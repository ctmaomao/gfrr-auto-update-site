import { fmtNumSafe, riskColor, trendClass } from './config.js?v=odp-pulse-factor-check-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=odp-pulse-factor-check-1';
