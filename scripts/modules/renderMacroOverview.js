...
import {
  ...
  fmtNumSafe,
  fmtDeltaSafe,
} from './config.js?v=odp-gdelt-web-ngrams-auto-1';
import { buildCrossValidationMatrix, buildMacroCoherence } from './buildCrossValidationMatrix.js?v=odp-gdelt-web-ngrams-auto-1';
import {
  brentModeZh,
  moduleTone,
  riskBiasZh,
...
} from './macroOverviewDisplayHelpers.js?v=odp-gdelt-web-ngrams-auto-1';
import { buildMacroOverviewHeadline, buildMacroOverviewVerdictBody } from './macroOverviewNarrative.js?v=odp-gdelt-web-ngrams-auto-1';
import { renderExternalAiAuxiliary } from './renderExternalAi.js?v=odp-gdelt-web-ngrams-auto-1';
import { renderTrendSvg } from './renderMacroTrend.js?v=odp-gdelt-web-ngrams-auto-1';
