...
import {
  ...
  fmtNumSafe,
  fmtDeltaSafe,
} from './config.js?v=health-hardening-1';
import { buildCrossValidationMatrix, buildMacroCoherence } from './buildCrossValidationMatrix.js?v=health-hardening-1';
import { MODULE_LABELS } from './decision.js?v=health-hardening-1';
import {
  brentModeZh,
  moduleTone,
  riskBiasZh,
...
} from './macroOverviewDisplayHelpers.js?v=health-hardening-1';
import { buildMacroOverviewHeadline, buildMacroOverviewVerdictBody } from './macroOverviewNarrative.js?v=health-hardening-1';
import { renderTrendSvg } from './renderMacroTrend.js?v=health-hardening-1';
