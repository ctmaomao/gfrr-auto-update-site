...
import {
  ...
  fmtNumSafe,
  fmtDeltaSafe,
} from './config.js?v=odp-oil-cross-confirmation-1';
import { buildCrossValidationMatrix, buildMacroCoherence } from './buildCrossValidationMatrix.js?v=odp-oil-cross-confirmation-1';
import { MODULE_LABELS } from './decision.js?v=odp-oil-cross-confirmation-1';
import {
  brentModeZh,
  moduleTone,
  riskBiasZh,
...
} from './macroOverviewDisplayHelpers.js?v=odp-oil-cross-confirmation-1';
import { buildMacroOverviewHeadline, buildMacroOverviewVerdictBody } from './macroOverviewNarrative.js?v=odp-oil-cross-confirmation-1';
