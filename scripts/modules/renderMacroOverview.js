...
import {
  ...
  fmtNumSafe,
  fmtDeltaSafe,
} from './config.js?v=mobile-narrow-blocks-1';
import { buildCrossValidationMatrix, buildMacroCoherence } from './buildCrossValidationMatrix.js?v=mobile-narrow-blocks-1';
