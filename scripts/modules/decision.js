import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=frontend-loading-state-1';
import { formatOnRrpYiUsd } from './format.js?v=frontend-loading-state-1';
