import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=odp-global-stock-gap-1';
import { formatOnRrpYiUsd } from './format.js?v=odp-global-stock-gap-1';
