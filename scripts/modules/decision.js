import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=odp-web-ngrams-health-1';
import { formatOnRrpYiUsd } from './format.js?v=odp-web-ngrams-health-1';
