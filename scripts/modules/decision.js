import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=stage-7-overlay-retire-1';
import { formatOnRrpYiUsd } from './format.js?v=stage-7-overlay-retire-1';
