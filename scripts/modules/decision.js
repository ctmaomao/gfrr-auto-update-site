import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=brent-held-age-cap-1';
import { formatOnRrpYiUsd } from './format.js?v=brent-held-age-cap-1';
