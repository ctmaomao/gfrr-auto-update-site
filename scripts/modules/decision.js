import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=coherence-ref-fallback-1';
import { formatOnRrpYiUsd } from './format.js?v=coherence-ref-fallback-1';
