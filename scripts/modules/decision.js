import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=stage-c5-batch1-world-indices-1';
import { formatOnRrpYiUsd } from './format.js?v=stage-c5-batch1-world-indices-1';
