import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=stage-c1-inflation-energy-1';
import { formatOnRrpYiUsd } from './format.js?v=stage-c1-inflation-energy-1';
