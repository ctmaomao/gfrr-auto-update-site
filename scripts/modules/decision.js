import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=oil-news-claim-axis-gate-1';
import { formatOnRrpYiUsd } from './format.js?v=oil-news-claim-axis-gate-1';
