import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=mobile-narrow-overrides-1';
import { formatOnRrpYiUsd } from './format.js?v=mobile-narrow-overrides-1';
