import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=frontend-failclosed-fallback-1';
import { formatOnRrpYiUsd } from './format.js?v=frontend-failclosed-fallback-1';
