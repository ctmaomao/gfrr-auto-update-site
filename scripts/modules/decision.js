import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=odp-news-event-watch-1';
import { formatOnRrpYiUsd } from './format.js?v=odp-news-event-watch-1';
