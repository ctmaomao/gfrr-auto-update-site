import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=macro-narrative-odp-1';
import { formatOnRrpYiUsd } from './format.js?v=macro-narrative-odp-1';
