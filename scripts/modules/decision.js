import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=transport-shock-caveat-1';
import { formatOnRrpYiUsd } from './format.js?v=transport-shock-caveat-1';
