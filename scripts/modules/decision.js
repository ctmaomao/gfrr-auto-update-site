import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=odp-energy-inventory-balance-1';
import { formatOnRrpYiUsd } from './format.js?v=odp-energy-inventory-balance-1';
