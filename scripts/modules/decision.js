import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=safe-dom-rendering-1';
import { formatOnRrpYiUsd } from './format.js?v=safe-dom-rendering-1';
