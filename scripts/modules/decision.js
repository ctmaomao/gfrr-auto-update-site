import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=stage-10-nbs-70city-1';
import { formatOnRrpYiUsd } from './format.js?v=stage-10-nbs-70city-1';
