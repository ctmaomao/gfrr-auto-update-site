import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=observation-reaction-layer-1';
import { formatOnRrpYiUsd } from './format.js?v=observation-reaction-layer-1';
