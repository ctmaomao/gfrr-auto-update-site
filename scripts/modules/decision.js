import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=frontend-stale-static-wire-4';
import { formatOnRrpYiUsd } from './format.js?v=frontend-stale-static-wire-4';
