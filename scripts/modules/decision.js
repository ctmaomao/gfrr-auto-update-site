import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=odp-pulse-factor-check-1';
import { formatOnRrpYiUsd } from './format.js?v=odp-pulse-factor-check-1';
