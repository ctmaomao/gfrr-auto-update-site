import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=odp-attribution-layer-1';
import { formatOnRrpYiUsd } from './format.js?v=odp-attribution-layer-1';
