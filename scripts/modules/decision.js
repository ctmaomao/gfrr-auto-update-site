import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=external-ai-low-maintenance-1';
import { formatOnRrpYiUsd } from './format.js?v=external-ai-low-maintenance-1';
