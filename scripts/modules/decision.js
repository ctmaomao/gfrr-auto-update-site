import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=odp-wti-market-proxy-1';
import { formatOnRrpYiUsd } from './format.js?v=odp-wti-market-proxy-1';
