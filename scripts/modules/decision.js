import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=frontend-stale-static-wire-3';
import { formatOnRrpYiUsd } from './format.js?v=frontend-stale-static-wire-3';
