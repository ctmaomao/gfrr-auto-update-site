import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=transport-shock-score-impact-1';
import { formatOnRrpYiUsd } from './format.js?v=transport-shock-score-impact-1';
