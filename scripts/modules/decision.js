import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=odp-decision-ladder-1';
import { formatOnRrpYiUsd } from './format.js?v=odp-decision-ladder-1';
