import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=stage-70city-detail-2';
import { formatOnRrpYiUsd } from './format.js?v=stage-70city-detail-2';
