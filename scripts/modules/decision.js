import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=stage-70city-detail-1';
import { formatOnRrpYiUsd } from './format.js?v=stage-70city-detail-1';
