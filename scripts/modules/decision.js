import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=odp-thermal-request-health-1';
import { formatOnRrpYiUsd } from './format.js?v=odp-thermal-request-health-1';
