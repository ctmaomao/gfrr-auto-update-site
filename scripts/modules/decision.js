import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=world-order-acled-freshness-1';
import { formatOnRrpYiUsd } from './format.js?v=world-order-acled-freshness-1';
