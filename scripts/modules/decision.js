import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=odp-responsive-readability-1';
import { formatOnRrpYiUsd } from './format.js?v=odp-responsive-readability-1';
