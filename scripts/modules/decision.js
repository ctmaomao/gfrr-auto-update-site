import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=batch-c-shipping-freight-1';
import { formatOnRrpYiUsd } from './format.js?v=batch-c-shipping-freight-1';
