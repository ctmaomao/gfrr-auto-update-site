import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=macro-risk-editorial-1';
import { formatOnRrpYiUsd } from './format.js?v=macro-risk-editorial-1';
