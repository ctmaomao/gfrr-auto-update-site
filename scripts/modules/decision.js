import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=thematic-ia-regional-last-1';
import { formatOnRrpYiUsd } from './format.js?v=thematic-ia-regional-last-1';
