import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=china-macro-intro-errata-1';
import { formatOnRrpYiUsd } from './format.js?v=china-macro-intro-errata-1';
