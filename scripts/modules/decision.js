import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=stage-14-tsf-eastmoney-1';
import { formatOnRrpYiUsd } from './format.js?v=stage-14-tsf-eastmoney-1';
