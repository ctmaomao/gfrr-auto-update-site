import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=trend-visual-match-1';
import { formatOnRrpYiUsd } from './format.js?v=trend-visual-match-1';
