import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=odp-news-source-attribution-2';
import { formatOnRrpYiUsd } from './format.js?v=odp-news-source-attribution-2';
