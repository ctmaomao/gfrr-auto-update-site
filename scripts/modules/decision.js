import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=signal-emoji-dedup-1';
import { formatOnRrpYiUsd } from './format.js?v=signal-emoji-dedup-1';
