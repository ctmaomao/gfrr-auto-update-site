import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=stage-ux-meta-cleanup-1';
import { formatOnRrpYiUsd } from './format.js?v=stage-ux-meta-cleanup-1';
