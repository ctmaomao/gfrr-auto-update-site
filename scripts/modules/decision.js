import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=trend-axis-label-copy-1';
import { formatOnRrpYiUsd } from './format.js?v=trend-axis-label-copy-1';
