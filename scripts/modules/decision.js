import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=odp-fold-after-verdict-1';
import { formatOnRrpYiUsd } from './format.js?v=odp-fold-after-verdict-1';
