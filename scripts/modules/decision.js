import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=macro-verdict-card-1';
import { formatOnRrpYiUsd } from './format.js?v=macro-verdict-card-1';
