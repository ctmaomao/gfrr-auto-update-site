import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=frontend-stale-static-tier1-1';
import { formatOnRrpYiUsd } from './format.js?v=frontend-stale-static-tier1-1';
