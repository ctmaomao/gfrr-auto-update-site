import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=batch-a-display-integrity-1';
import { formatOnRrpYiUsd } from './format.js?v=batch-a-display-integrity-1';
