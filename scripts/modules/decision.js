import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=frontend-stale-static-tier2-1';
import { formatOnRrpYiUsd } from './format.js?v=frontend-stale-static-tier2-1';
