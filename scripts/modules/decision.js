import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=mobile-trend-width-1';
import { formatOnRrpYiUsd } from './format.js?v=mobile-trend-width-1';
