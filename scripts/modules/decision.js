import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=odp-thermal-watch-shell-1';
import { formatOnRrpYiUsd } from './format.js?v=odp-thermal-watch-shell-1';
