import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=stage-c2-copper-gold-ratio-1';
import { formatOnRrpYiUsd } from './format.js?v=stage-c2-copper-gold-ratio-1';
