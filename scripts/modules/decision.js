import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=odp-web-ngrams-age-1';
import { formatOnRrpYiUsd } from './format.js?v=odp-web-ngrams-age-1';
