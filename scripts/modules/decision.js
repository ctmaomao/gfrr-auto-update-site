import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=stage-9-c6-intro-errata-1';
import { formatOnRrpYiUsd } from './format.js?v=stage-9-c6-intro-errata-1';
