import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=release-version-semantics-v28.0.10-1';
import { formatOnRrpYiUsd } from './format.js?v=release-version-semantics-v28.0.10-1';
