...
Market pricing status: v28.0M-15A documents unified data pipeline architecture; Market Pricing is assigned to daily/history plus artifact sanitizer layers, not an isolated pipeline.
