...
Market pricing status: v28.0M-15 adds a source-specific artifact fetch scaffold with network disabled; live fetch, production history writes, and calculations remain disabled.
