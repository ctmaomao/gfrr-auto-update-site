...
本文档供 Cursor、Codex 和其他 AI 工具接手本项目时优先阅读。目标是保护当前 v27.x 稳定化基线，避免误改核心数据链路、决策契约和部署保护网。

## 1. 项目当前状态

当前项目处于 v27.x 稳定化阶段。

维护重点是稳定性、可观测性、数据契约和小步改进。没有明确任务时，不应大规模重构，不应重写站点结构，不应把项目改成 demo 或简化版。
...
- `docs/V27_BASELINE.md`：当前 v27.x 稳定化基线。做架构或功能判断前，先读此文档。
